...
monthly_usage.plot(kind='bar', color='pink', title='Використання велодоріжок по місяцях')
plt.xlabel('Місяць', color='purple')
plt.ylabel('Кількість використань', color='purple')
