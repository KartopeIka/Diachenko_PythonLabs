...
plt.plot(years, values_country_1, label=country_1, color="pink", marker="o")
plt.plot(years, values_country_2, label=country_2, color="purple", marker="o")

# Підпис осей і графіка
plt.title("Dynamics of Indicator for Two Countries", fontsize=15)
plt.xlabel("Year", fontsize=12, color="blue")
plt.ylabel("Indicator Value", fontsize=12, color="blue")
plt.legend()
plt.grid(True)
